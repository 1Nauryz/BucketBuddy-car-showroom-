...
Route::middleware('auth')->group(function (){
    ...
    Route::post('/cars/destroymessage/{car}', [CarController::class, 'dMessage'])->name('cars.dMessage');
    Route::post('/cars/{car}/updateMes', [CarController::class, 'updateMes'])->name('cars.updateMes');
    Route::post('/cars/storeMes', [CarController::class, 'storeMes'])->name('cars.storeMes');

    Route::get('/cars/upbalance/{user}', [CarController::class, 'upBalance'])->name('cars.balance');
    Route::post('/balance/store', [CarController::class, 'balanceStore'])->name('balance.store');
    Route::post('/cars/buy/{car}', [CarController::class, 'buyCar'])->name('cars.buy');
    ...
    Route::prefix('adm')->as('adm.')->middleware('hasrole:admin,editor')->group(function (){
        ...
        Route::get('/comments',[UserController::class, 'indexCom'])->name('comments.index');
        Route::delete('/comments/destroy/{comment}', [UserController::class, 'destroyCom'])->name('comments.destroy');

        Route::get('/users/search', [UserController::class, 'index'])->name('users.search');
        Route::get('/comment/search', [UserController::class, 'indexCom'])->name('comments.search');
